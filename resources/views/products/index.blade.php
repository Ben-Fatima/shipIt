<x-layout>
  ...
  <a class="block flex" href="/products/create">
    <div class="flex-grow"></div>
    <button class="py-2 px-4 rounded-full bg-orange-600 my-6 text-gray-200 hover:bg-orange-700">Add new product</button></a
  >
